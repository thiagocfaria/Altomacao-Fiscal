...
| Escopo | **Somente este projeto** — desativado globalmente, ativo via `.claude/settings.json` na raiz |
...
| `.cbmignore` | Configurado na raiz para excluir `RENOMEADOR/src/test/resources/nfse-modelos/` e `docs/operacao/` |
...
As skills especificas do modulo ficam em `RENOMEADOR/.claude/skills/`.

### guardiao-arquitetura-nfse

| Item | Detalhe |
|---|---|
| Arquivo | `RENOMEADOR/.claude/skills/guardiao-arquitetura-nfse/SKILL.md` |
...
| Item | Detalhe |
|---|---|
| Arquivo | `RENOMEADOR/.claude/skills/implementacao-java/SKILL.md` |
...
| Item | Detalhe |
|---|---|
| Arquivo | `RENOMEADOR/.claude/skills/layout-nfse/SKILL.md` |
...
| Item | Detalhe |
|---|---|
| Arquivo | `RENOMEADOR/.claude/skills/equipe-testes-nfse/SKILL.md` |
...
| Item | Detalhe |
|---|---|
| Arquivo | `RENOMEADOR/.claude/skills/validacao-extracao-pdf/SKILL.md` |
...
| Lote piloto | `RENOMEADOR/src/test/resources/nfse-modelos/` (15 arquivos, 2 layouts, 1 multi-nota, 1 cancelada) |

### validacao-performance-java

| Item | Detalhe |
|---|---|
| Arquivo | `RENOMEADOR/.claude/skills/validacao-performance-java/SKILL.md` |
...
| Item | Detalhe |
|---|---|
| Arquivo | `RENOMEADOR/.claude/skills/pesquisa-tecnica-java/SKILL.md` |
...
- [x] Plugin ativo somente aqui via `.claude/settings.json` na raiz
- [x] Skills criadas em `RENOMEADOR/.claude/skills/`
...
- [ ] Verificar se `.claude/settings.json` da raiz deve ser usado nessa maquina
- [ ] Rodar `mvn test`
